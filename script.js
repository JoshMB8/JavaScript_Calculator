...
class Calculator extends React.Component {
  ...
  handleOperators(event) {
    if (!this.state.currentVal.includes("Many")) {
  ...
  handleDecimal() {
    if (this.state.evaluated === true) {
      ...
      !this.state.currentVal.includes("Many")
    ) {
  ...
  render() {
    return(
      <div>
        ...
        <footer className="author">made by:
          <a href="https://codepen.io/joshmb8" target="_blank"> JMBall</a>
        </footer>
      </div>
    )
  }
